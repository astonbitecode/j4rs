...
pub fn new_jvm(classpath_entries: Vec<ClasspathEntry>, java_opts: Vec<JavaOpt>) -> errors::Result<Jvm> {
    ...
    default_classpath_entry.push("j4rs-0.2.0-SNAPSHOT-jar-with-dependencies.jar");
    ...
    tests_classpath_entry.push("j4rs-0.2.0-SNAPSHOT-jar-with-dependencies.jar");

    let default_class_path = format!("-Djava.class.path={}{}{}",
                                     default_classpath_entry
                                         .to_str()
                                         .unwrap_or("./jassets/j4rs-0.2.0-SNAPSHOT-jar-with-dependencies.jar"),
                                     utils::classpath_sep(),
