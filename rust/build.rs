...
fn copy_jars_from_java() {
    ...
    if File::open("../java/target/j4rs-0.2.0-SNAPSHOT-jar-with-dependencies.jar").is_ok() {
        ...
        let jar_source_path = "../java/target/j4rs-0.2.0-SNAPSHOT-jar-with-dependencies.jar";
